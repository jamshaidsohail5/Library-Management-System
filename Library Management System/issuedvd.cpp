...
issuedvd::issuedvd(QWidget *parent,QString n) :
    QMainWindow(parent),
    ui(new Ui::issuedvd)
{
    name = n;
...
void issuedvd::on_pushButton_clicked()
{
    singletonlms lms;
    State * s;
    ...
    qDebug()<<QString::fromStdString(li->get_title());
...
void issuedvd::on_comboBox_2_activated(const QString &arg1)
{
