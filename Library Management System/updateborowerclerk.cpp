...
#include "ui_updateborowerclerk.h"
...
updateborowerclerk::updateborowerclerk(QWidget *parent,QString n) :
    QMainWindow(parent),
    ui(new Ui::updateborowerclerk)
{
    ui->setupUi(this);
    name = n;
...
updateborowerclerk::~updateborowerclerk()
{
    delete ui;
}

void updateborowerclerk::on_comboBox_2_activated(const QString &arg1)
{
    if(arg1 == "name")
    {
...
void updateborowerclerk::on_pushButton_clicked()
{
