...
issuedvd2::issuedvd2(QWidget *parent,QString i) :
    QMainWindow(parent),
    ui(new Ui::issuedvd2)
{
    name =i;
...
void issuedvd2::on_pushButton_clicked()
{
    singletonlms lms;
    State *s ;
...
void issuedvd2::on_comboBox_2_activated(const QString &arg1)
{
