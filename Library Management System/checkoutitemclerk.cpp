...
#include "ui_checkoutitemclerk.h"
...
checkoutitemclerk::checkoutitemclerk(QWidget *parent,QString n) :
    QMainWindow(parent),
    ui(new Ui::checkoutitemclerk)
{
    ui->setupUi(this);
    name = n ;
}

checkoutitemclerk::~checkoutitemclerk()
{
    delete ui;
...
void checkoutitemclerk::on_pushButton_clicked()
{
